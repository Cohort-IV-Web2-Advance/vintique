...
function getUser() {
  try {
    return JSON.parse(localStorage.getItem("vintique_user"));
  } catch {
    return null;
  }
}
...
const adminAPI = {
  ...
  makeUserAdmin(id) {
    return fetch(`${API_BASE}/admin/users/${id}/make-admin`, {
      method: "PATCH",
  ...
  // revokeAdmin(userId) {
  //   return fetch(`${API_BASE}/admin/users/account-action`, {
  //     method: "POST",
  //     headers: {
  //       "Content-Type": "application/json",
